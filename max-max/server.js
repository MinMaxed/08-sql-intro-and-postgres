...
app.get('/new', (request, response) => {
  ...
  // #2 & #5 of the .png. this piece of code is not interacting with article.js. get, a REST verb, is Read of CRUD.
...
// its checking if there's anything in the DB and if so, loading from it. if there's nothing in the DB, it will populate it.
loadDB();
...
function loadArticles() {
  // COMMENT: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // #3 & #4 of the .png. We dont think this is being directly used by the article.js. This is Read of CRUD.
...
function loadDB() {
  // COMMENT: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // #4 of the .png. not directly working with article.js. Read of CRUD. 
  client.query(`
